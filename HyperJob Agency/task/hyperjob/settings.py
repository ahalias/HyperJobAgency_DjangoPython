...
VACANCY_TEMPLATE_PATH = os.path.join(BASE_DIR, 'vacancy/templates')
RESUME_TEMPLATE_PATH = os.path.join(BASE_DIR, 'resume/templates')
...
TEMPLATES = [
    {
        ...
        'DIRS': [VACANCY_TEMPLATE_PATH, RESUME_TEMPLATE_PATH],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
